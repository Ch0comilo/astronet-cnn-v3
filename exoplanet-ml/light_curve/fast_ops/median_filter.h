...
#ifndef EXOPLANET_ML_LIGHT_CURVE_FAST_OPS_MEDIAN_FILTER_H_
#define EXOPLANET_ML_LIGHT_CURVE_FAST_OPS_MEDIAN_FILTER_H_
...
#endif  // EXOPLANET_ML_LIGHT_CURVE_FAST_OPS_MEDIAN_FILTER_H_
