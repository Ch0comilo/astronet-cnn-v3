...
#ifndef EXOPLANET_ML_LIGHT_CURVE_FAST_OPS_NORMALIZE_H_
#define EXOPLANET_ML_LIGHT_CURVE_FAST_OPS_NORMALIZE_H_
...
#endif  // EXOPLANET_ML_LIGHT_CURVE_FAST_OPS_NORMALIZE_H_
