...
#ifndef EXOPLANET_ML_LIGHT_CURVE_FAST_OPS_TEST_UTIL_H_
#define EXOPLANET_ML_LIGHT_CURVE_FAST_OPS_TEST_UTIL_H_
...
#endif  // EXOPLANET_ML_LIGHT_CURVE_FAST_OPS_TEST_UTIL_H_
