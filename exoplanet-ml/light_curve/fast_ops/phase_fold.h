...
#ifndef EXOPLANET_ML_LIGHT_CURVE_FAST_OPS_PHASE_FOLD_H_
#define EXOPLANET_ML_LIGHT_CURVE_FAST_OPS_PHASE_FOLD_H_
...
#endif  // EXOPLANET_ML_LIGHT_CURVE_FAST_OPS_PHASE_FOLD_H_
